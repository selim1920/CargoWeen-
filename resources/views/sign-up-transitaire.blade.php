    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
            ...
            <form action="{{route('create_transitaire')}}" method="post" autocomplete="off" class="sign-in-form" id="login-form">
                @if (session('success'))
             ...
             {{ session('success') }}
               ...
               {{ session('fail') }}
                      ...
                      @endif
               @csrf
            <h2 class="title">Inscription Transitaire</h2>
          ...
          <div class="form-step" id="step2">
            ...
            <div class="input-field">
              <i class="fas fa-envelope"></i>
              <input type="text" name="numero_cass" id="numero_cass" placeholder="Numero_CASS"  value="{{old('numero_cass')}}"required autofocus autocomplete="numero_cass" />
            </div>
